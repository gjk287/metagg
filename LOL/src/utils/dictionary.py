class GameDictionary(object):
	def __init__(self):
		...
		self.playerName_dict = {
			...
			**dict.fromkeys(['DanChung', 'Dancheong', 'Mala'], 'Danchung'),
			...
			**dict.fromkeys(['Reat1vo', 'Reat1voo', 'Reat1vo', 'REA1'], 'ReAt1vo'),
			...
			**dict.fromkeys(['itsC0RTEZ', 'itsCORTEZ', 'itsCortez'], 'ItsCortez'),
			...
			**dict.fromkeys(['xiaoxiang'], 'Xiaoxiang'),
			**dict.fromkeys(['BrTT'], 'brTT'),
			**dict.fromkeys(['WEI'], 'Wei'),
			**dict.fromkeys(['spunk'], 'Spunk'),
			**dict.fromkeys(['Sofm'], 'SofM'),
			**dict.fromkeys(['IBoy'], 'iBoy'),
			**dict.fromkeys(['Icon'], 'icon'),
			**dict.fromkeys(['Weiyan'], 'WeiYan'),
			**dict.fromkeys(['Mumus100'], 'mumus100'),
			**dict.fromkeys(['Jinjao'], 'Jinjiao'),
			**dict.fromkeys(['Sixsix9'], 'sixsix9'),
			**dict.fromkeys(['lwx'], 'Lwx'),
			**dict.fromkeys(['Y1TT'], 'poge'),
			**dict.fromkeys(['Tockers'], 'tockers'),
			**dict.fromkeys(['Assqssin'], 'assassin'),
			**dict.fromkeys(['Godlou'], 'GodLou'),
			**dict.fromkeys(['ice'], 'bans'),
			**dict.fromkeys(['XC'], 'Windy'),
			**dict.fromkeys(['XXD'], 'Clap'),
			**dict.fromkeys(['Irma'], 'irma'),
			**dict.fromkeys(['JZ', 'Jz'], 'Spike'),
			**dict.fromkeys(['Amaj'], 'Yolanda'),
			**dict.fromkeys(['XPZ'], 'HwQ'),
			**dict.fromkeys(['Chelly'], 'SR99'),
			**dict.fromkeys(['UP', 'up'], 'Recall'),
			**dict.fromkeys(['Minn9'], 'Humble'),
			**dict.fromkeys(['Yoghurt'], 'Insulator'),
			**dict.fromkeys(['Moonlight'], 'Yui'),
			**dict.fromkeys(['Pepper'], 'Y1han'),
			**dict.fromkeys(['Celestial'], 'babo'),
			**dict.fromkeys(['Aphromoo'], 'aphromoo'),
			**dict.fromkeys(['CHange'], 'Chance'),
			**dict.fromkeys(['Gimgoon'], 'GimGoon'),
			**dict.fromkeys(['captain'], 'Captain'),
			**dict.fromkeys(['Enjoy'], 'enjoy'),
			**dict.fromkeys(['fate'], 'Reheal'),
			**dict.fromkeys(['Pawn'], 'PawN'),
			**dict.fromkeys(['Chenlun17'], 'chenlun17'),
			**dict.fromkeys(['Kabu'], 'Zhuangzhou'),
			**dict.fromkeys(['corn'], 'Corn'),
			**dict.fromkeys(['Cody'], 'cody'),
			**dict.fromkeys(['PiPiXuAn', 'XuanXuanPi'], 'PiPiXuan'),
			**dict.fromkeys(['TinOwns', 'Tinowns'], 'tinowns'),
			**dict.fromkeys(['nanzhu'], 'Nanzhu'),
			**dict.fromkeys(['Y4'], 'y4'),
			**dict.fromkeys(['ALU'], 'Alu'),
			**dict.fromkeys(['Panfeng'], 'Peace'),
			**dict.fromkeys(['Leuumon'], 'lelebbi'),
			**dict.fromkeys(['Swordart', 'SwordArT'], 'SwordArt'),
			**dict.fromkeys(['Xiaohan'], 'xiaohan'),
			**dict.fromkeys(['keke'], 'Ke'),
			**dict.fromkeys(['JieJie'], 'Jiejie'),
			**dict.fromkeys(['ShaDow'], 'Shadow'),
			**dict.fromkeys(['YanXuan'], 'yanxuan'),
			**dict.fromkeys(['SamD'], 'Samd'),
			**dict.fromkeys(['April'], 'Savior'),
			**dict.fromkeys(['shark'], 'Shark'),
			**dict.fromkeys(['Tusin'], 'TusiN'),
			**dict.fromkeys(['Fabfabulous'], 'fabFabulous'),
			**dict.fromkeys(['ZWuji'], 'ZWuJi'),
			**dict.fromkeys(['Cuvee'], 'CuVee'),
			**dict.fromkeys(['catch'], 'Catch'),
			**dict.fromkeys(['Cepted'], 'cepted'),
			**dict.fromkeys(['DyNquedo', 'Dynquedo'], 'dyNquedo'),
			**dict.fromkeys(['Wuy'], 'yuWWuu'),
			**dict.fromkeys(['YaGao'], 'Yagao'),
			**dict.fromkeys(['Beishang'], 'beishang'),
			**dict.fromkeys(['CH1rry', 'ch1rry'], 'Ch1rry'),
			**dict.fromkeys(['Xinyi'], 'ping'),
			**dict.fromkeys(['Yi'], 'zs'),
			**dict.fromkeys(['Virus'], 'Vortex'),
			**dict.fromkeys(['Gala'], 'GALA'),
			**dict.fromkeys(['noble'], 'Noble'),
			**dict.fromkeys(['JiuMeng'], 'Jiumeng'),
			**dict.fromkeys(['EsA'], 'esA'),
			**dict.fromkeys(['Imp'], 'imp'),
			**dict.fromkeys(['sleepy'], 'Sleepy'),
			**dict.fromkeys(['Steel'], 'Wuming'),
			**dict.fromkeys(['HuaTian'], 'MaiX'),
			**dict.fromkeys(['XiaoBai'], 'Xiaobai'),
			**dict.fromkeys(['Five'], 'cold'),
			**dict.fromkeys(['Aitong'], 'bless'),
			**dict.fromkeys(['BrokenBlade'], 'Broken Blade'),
			**dict.fromkeys(['Lwandy'], 'lwandy'),
			**dict.fromkeys(['Metoer'], 'Meteor'),
			**dict.fromkeys(['Ale'], 'Natural'),
			**dict.fromkeys(['Ytt'], 'ytt'),
			**dict.fromkeys(['Xiye'], 'xiye'),
			**dict.fromkeys(['Roysen'], 'linger'),
			**dict.fromkeys(['ylj'], 'Ylj'),
			**dict.fromkeys(['doinb'], 'Doinb'),
			**dict.fromkeys(['Yuyanjia'], 'yuyanjia'),
			**dict.fromkeys(['Huanfeng'], 'huanfeng'),
			**dict.fromkeys(['idt'], '1dt'),
			**dict.fromkeys(['Oni'], 'mogu'),
			**dict.fromkeys(['Pbo', 'PbO'], 'pbO'),
			**dict.fromkeys(['beige'], 'Beige'),
			**dict.fromkeys(['yimeng'], 'Yimeng'),
			**dict.fromkeys(['smlz'], 'Smlz'),
			**dict.fromkeys(['SouthWind'], 'Southwind'),
			**dict.fromkeys(['TheFan'], 'sqb'),
			**dict.fromkeys(['Knight9'], 'knight'),
			**dict.fromkeys(['XiaoAL'], 'Langx'),
			**dict.fromkeys(['Aris'], 'Arise'),
			**dict.fromkeys(['potm'], 'Potm'),
			**dict.fromkeys(['Sks'], 'Wisdomz'),
			**dict.fromkeys(['Xiao7'], 'xiao7'),
			**dict.fromkeys(['Huhi'], 'huhi'),
			**dict.fromkeys(['Xiaowei'], 'Twila'),
			**dict.fromkeys(['Crossman'], 'Burak'),
			**dict.fromkeys(['ClearG'], 'Clear'),
			**dict.fromkeys(['BlazeS'], 'Blazes'),
			**dict.fromkeys(['Gentle'], 'GENTLE'),
			**dict.fromkeys(['Caveman'], 'Duan'),
			**dict.fromkeys(['xiaolongbao'], 'XLB'),
			**dict.fromkeys(['Kriss Kyle'], 'KrissKyle'),
			**dict.fromkeys(['xin'], 'Forge'),
			**dict.fromkeys(['Xuzhu'], 'Daylight'),
			**dict.fromkeys(['Loken'], 'LokeN'),
			**dict.fromkeys(['Carl'], 'Leyan'),
			**dict.fromkeys(['xinnu'], 'Punk'),
			**dict.fromkeys(['xiaoliulian'], 'Wings'),
			**dict.fromkeys(['Plume'], 'Ylj'),
			**dict.fromkeys(['Machao'], 'Chase'),
			**dict.fromkeys(['wei'], 'Wei'),
			**dict.fromkeys(['Like'], 'AKi'),
			**dict.fromkeys(['bin'], 'Bin'),
			**dict.fromkeys(['RooKie'], 'Rookie'),
			**dict.fromkeys(['Pang'], 'Truth')
		}
